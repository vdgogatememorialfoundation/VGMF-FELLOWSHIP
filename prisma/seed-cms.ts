...
const DEFAULT_FIELDS = [
  ...
  { section: "Personal Details", label: "Team Name", fieldKey: "team_name", fieldType: "TEXT" as const, required: false, order: 2 },
  { section: "Personal Details", label: "Number of Team Members", fieldKey: "team_member_count", fieldType: "NUMBER" as const, required: false, order: 3 },
  { section: "Official Communication Details", label: "Official Contact Person", fieldKey: "official_contact_person", fieldType: "TEXT" as const, required: false, order: 1 },
  { section: "Official Communication Details", label: "Alternate Mobile Number", fieldKey: "alternate_mobile", fieldType: "PHONE" as const, required: false, order: 2 },
  { section: "Official Communication Details", label: "Official Postal Address", fieldKey: "official_postal_address", fieldType: "TEXTAREA" as const, required: false, order: 3 },
  { section: "Attachments Checklist", label: "Proof of Age", fieldKey: "age_proof", fieldType: "FILE" as const, required: true, order: 45, helpText: "Upload a document proving your age (e.g., birth certificate, school ID)." },
  { section: "Attachments Checklist", label: "Identity Proof", fieldKey: "identity_proof", fieldType: "FILE" as const, required: true, order: 46, helpText: "Upload a government ID or passport for identity verification." },
  { section: "Attachments Checklist", label: "Other Supporting Document", fieldKey: "other_supporting_document", fieldType: "FILE" as const, required: false, order: 47, helpText: "Any additional documents (publications, achievements, etc.)." },
  { section: "Professional Details", label: "NCISM Registration Certificate", fieldKey: "ncism_registration_certificate", fieldType: "FILE" as const, required: true, order: 17, helpText: "Upload NCISM registration certificate (PDF or image). For Group applications, combine all members' certificates into a single PDF." },
