    ...
    const integrationsRes = await fetch("/api/admin/cms", {
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          setuClientId: integrations.setuClientId?.trim() || undefined,
          setuClientSecret: integrations.setuClientSecret?.trim() || undefined,
          setuProductInstanceId: integrations.setuProductInstanceId?.trim() || undefined,
        },
      }),
      cache: "no-store",
      credentials: "include",
